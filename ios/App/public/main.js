...
module.exports = __webpack_require__(/*! D:\Users\IndigoMontoya\Documents\angular\kyber\src\main.ts */"zUnb");
...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | pages-account-settings-account-settings-module */ "pages-account-settings-account-settings-module").then(__webpack_require__.bind(null, /*! ./pages/account-settings/account-settings.module */ "3ZRc")).then(m => m.AccountSettingsPageModule)
    },
    {
        path: 'authorize',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-authorize-authorize-module */ "pages-authorize-authorize-module").then(__webpack_require__.bind(null, /*! ./pages/authorize/authorize.module */ "x+Bk")).then(m => m.AuthorizePageModule)
    },
    {
        path: 'init-authorize',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-init-authorize-init-authorize-module */ "pages-init-authorize-init-authorize-module").then(__webpack_require__.bind(null, /*! ./pages/init-authorize/init-authorize.module */ "iEEo")).then(m => m.InitAuthorizePageModule)
    },
    {
        path: 'login',
    ...
    {
        path: 'pay',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-pay-pay-module */ "pages-pay-pay-module").then(__webpack_require__.bind(null, /*! ./pages/pay/pay.module */ "nDJg")).then(m => m.PayPageModule)
    },
    {
        path: 'pin',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-pin-pin-module */ "pages-pin-pin-module").then(__webpack_require__.bind(null, /*! ./pages/pin/pin.module */ "oKaW")).then(m => m.PinPageModule)
    },
    {
        path: 'privacy',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-privacy-privacy-module */ "pages-privacy-privacy-module").then(__webpack_require__.bind(null, /*! ./pages/privacy/privacy.module */ "ujr7")).then(m => m.PrivacyPageModule)
    },
    {
        path: 'reset-pass',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-reset-pass-reset-pass-module */ "pages-reset-pass-reset-pass-module").then(__webpack_require__.bind(null, /*! ./pages/reset-pass/reset-pass.module */ "Plc9")).then(m => m.ResetPassPageModule)
    },
    {
        path: 'reset-pin',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-reset-pin-reset-pin-module */ "pages-reset-pin-reset-pin-module").then(__webpack_require__.bind(null, /*! ./pages/reset-pin/reset-pin.module */ "GBg5")).then(m => m.ResetPinPageModule)
    },
    {
        path: 'wallet',
